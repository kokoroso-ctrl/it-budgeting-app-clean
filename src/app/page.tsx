          ...
          <div className="flex items-center justify-between p-3 sm:p-4 gap-2">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 overflow-hidden">
              ...
              <button
                ...
                className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white font-semibold text-sm shrink-0 hover:opacity-90 transition-opacity cursor-pointer"
              >
